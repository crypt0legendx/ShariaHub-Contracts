...
loader.load(web3, 'ShariaHubStorage', storageAddress).then(async (storageInstance) => {
    // await storageInstance.methods.setBool(
    //         web3const utils = require("web3-utils");.soliditySha3('user','representative',representative),
    //         true
    //         )
    //         .send({
    //             from:account,
