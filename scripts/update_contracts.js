...
loader.load(web3, 'ShariaHubCMC').then( cmcInstance => {
    cmc = cmcInstance;
    return loader.load(web3, 'ShariaHubStorage').then( async (storageInstance) =>  {
        storageAddress = await storageInstance.options.address;
        return web3.eth.getAccounts().then(accounts => {

            const deployable = loader.getDeployable(web3,'ShariaHubReputation');
...
// loader.getContractWrapper(web3, 'ShariaHubReputation').deploy({
//     data: '0x12345...',
